      ...
      {images.map((img, index) => (
        ...
        >
          <img
            ...
            onError={(e) => {
              // Fallback si la imagen local no se encuentra
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20">
        <div className="max-w-2xl">
          ...
          <p className="text-xl leading-8 text-slate-300 mb-10 max-w-lg">
            Llevá tu pádel al siguiente nivel con una metodología profesional de alto rendimiento en Santiago del Estero.
          </p>
