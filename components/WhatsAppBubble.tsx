  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] group flex items-center gap-3">
      ...
      <a 
        ...
        className="relative w-16 h-16 bg-[#25D366] rounded-full shadow-[0_8px_30px_rgb(37,211,102,0.4)] flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300"
      >
        {/* Efecto de Pulso */}
